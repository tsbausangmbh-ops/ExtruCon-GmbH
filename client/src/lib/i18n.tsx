...
export const translations = {
  ...
  tr: {
    ...
    about: {
      ...
      description: 'ExtruCon GmbH dijital dönüşüm için ortağınızdır. İşletmeleri daha verimli hale getiren AI çözümleri geliştiriyoruz.',
      whyUs: 'Neden biz?',
    ...
    funnel: {
      title: '3 adımda',
      titleHighlight: 'AI çözümünüz',
      step1: 'İlk Görüşme',
      step1Desc: 'İhtiyaç analizi için ücretsiz danışma görüşmesi',
      step2: 'Konsept',
    ...
    problem: {
      ...
      problems: [
        ...
        'Kaçırılan müşteri sorguları',
        'Tutarsız iletişim',
        'Yüksek personel maliyetleri',
      ],
      solution: 'ExtruCon ile',
      solutionHighlight: 'çözüm',
      solutions: [
    ...
    chatbot: {
      title: 'AI Asistan',
      subtitle: 'Akıllı sohbet botumuzu test edin',
