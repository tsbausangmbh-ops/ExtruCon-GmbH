...
export const translations = {
  de: {
    ...
    cookiePage: {
      ...
      legalBasisDesc: 'Die Verwendung von Cookies basiert auf der EU-Datenschutz-Grundverordnung (DSGVO) EU 2016/679, dem Bundesdatenschutzgesetz (BDSG), dem Telemediengesetz (TMG) und dem Telekommunikation-Telemedien-Datenschutz-Gesetz (TTDSG). Der Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI) ist die zuständige Aufsichtsbehörde.',
      yourRights: 'Ihre Rechte',
      yourRightsDesc: 'Nach deutschem und EU-Recht haben Sie das Recht auf: Auskunft über Ihre Daten, Berichtigung unrichtiger Daten, Löschung ("Recht auf Vergessenwerden"), Einschränkung der Verarbeitung, Widerspruch gegen die Verarbeitung sowie Datenübertragbarkeit.',
  ...
  en: {
    ...
    cookiePage: {
      ...
      legalBasisDesc: 'The use of cookies is based on the EU General Data Protection Regulation (GDPR) EU 2016/679 and applicable national data protection laws. Our website complies with EU data protection standards.',
      yourRights: 'Your Rights',
      yourRightsDesc: 'Under EU and applicable national law, you have the right to: access your data, rectify inaccurate data, delete data ("right to be forgotten"), restrict processing, object to processing, and data portability.',
  ...
  hr: {
    ...
    cookiePage: {
      ...
      legalBasisDesc: 'Korištenje kolačića temelji se na Općoj uredbi o zaštiti podataka (GDPR) EU 2016/679, Zakonu o provedbi Opće uredbe o zaštiti podataka (NN 42/18) te Zakonu o elektroničkim komunikacijama (NN 73/08). Agencija za zaštitu osobnih podataka (AZOP) je nadzorno tijelo za zaštitu podataka u Republici Hrvatskoj.',
      yourRights: 'Vaša prava',
      yourRightsDesc: 'Prema hrvatskom zakonu i EU GDPR-u, imate pravo na: pristup vašim podacima, ispravak netočnih podataka, brisanje podataka ("pravo na zaborav"), ograničenje obrade, prigovor na obradu te prijenos podataka. Za sva pitanja možete kontaktirati AZOP na azop.hr.',
  ...
  tr: {
    ...
    cookiePage: {
      ...
      legalBasisDesc: 'Çerez kullanımı, 6698 sayılı Kişisel Verilerin Korunması Kanunu (KVKK), 5809 sayılı Elektronik Haberleşme Kanunu ve AB Genel Veri Koruma Tüzüğü (GDPR) EU 2016/679\'a dayanmaktadır. Kişisel Verileri Koruma Kurumu (KVKK) Türkiye\'deki veri koruma denetim makamıdır.',
      yourRights: 'Haklarınız',
      yourRightsDesc: 'KVKK ve AB GDPR kapsamında şu haklara sahipsiniz: verilerinize erişim, yanlış verilerin düzeltilmesi, verilerin silinmesi ("unutulma hakkı"), işlemenin kısıtlanması, işlemeye itiraz ve veri taşınabilirliği. Sorularınız için kvkk.gov.tr adresinden KVKK\'ya başvurabilirsiniz.',
