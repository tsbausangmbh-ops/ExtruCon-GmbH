...
export const translations = {
  de: {
    ...
    hero: {
      location: 'Fürstenfeldbruck · München · Bayern · DACH-Region',
    ...
    contact: {
      ...
      phone: 'Anrufen',
      webpage: 'Webpage',
      directAppointment: 'Direkt-Termin',
    ...
    contactPage: {
      ...
      nationwideTitle: 'DACH-Region Service',
      nationwideDesc: 'Unser Hauptsitz ist in Fürstenfeldbruck bei München. Wir arbeiten online in der gesamten DACH-Region (Deutschland, Österreich, Schweiz).',
    ...
    locations: {
      common: {
        freeConsultation: 'Kostenlose Beratung',
        bookAppointment: 'Termin buchen',
        partnerTitle: 'Ihr Partner für KI & Automatisierung in',
        contactIn: 'Kontakt in',
        phone: 'Telefon',
        email: 'E-Mail',
        hours: 'Öffnungszeiten',
        hoursValue: 'Mo-Fr: 08:00 - 18:00 Uhr',
        showOnMaps: 'Auf Google Maps anzeigen',
        servicesTitle: 'Unsere Leistungen in',
        servicesSubtitle: 'Wir unterstützen Unternehmen in',
        servicesSubtitleEnd: 'mit innovativen KI-Lösungen.',
        industriesTitle: 'Branchen in',
        industriesSubtitle: 'Wir haben Erfahrung mit verschiedenen Branchen in der Region.',
        nearbyTitle: 'Wir betreuen auch Unternehmen in der Umgebung',
        ctaTitle: 'Bereit für die digitale Zukunft in',
        ctaSubtitle: 'Lassen Sie uns gemeinsam herausfinden, wie KI und Automatisierung Ihr Unternehmen voranbringen können.',
        ctaContact: 'Jetzt Kontakt aufnehmen',
        ctaBooking: 'Kostenloses Erstgespräch',
        kiAgency: 'KI-Agentur',
        region: 'Deutschland',
        breadcrumbHome: 'Startseite',
        breadcrumbLocations: 'Standorte',
        seoKeywords: 'KI-Agentur, Automatisierung, KI',
        services: {
          kiAgents: { title: 'KI-Agenten', desc: 'Intelligente Chatbots und virtuelle Assistenten für Kundenservice und Lead-Generierung.' },
          automation: { title: 'Automatisierung', desc: 'Workflow-Automatisierung mit n8n für effizientere Geschäftsprozesse.' },
          websites: { title: 'Webseiten mit KI', desc: 'Moderne Websites mit integrierten KI-Features und Chatbots.' },
          marketing: { title: 'Performance Marketing', desc: 'Google Ads, Meta Ads und SEO für maximale Sichtbarkeit.' }
        }
      },
      muenchen: {
        name: 'München',
  ...
  en: {
    ...
    contact: {
      ...
      phone: 'Call',
      webpage: 'Website',
      directAppointment: 'Direct Appointment',
    ...
    contactPage: {
      ...
      nationwideTitle: 'DACH Region Service',
      nationwideDesc: 'Our headquarters is in Fürstenfeldbruck near Munich. We work online throughout the DACH region (Germany, Austria, Switzerland).',
    ...
    terminbuchungPage: {
      ...
      subtitle: 'Choose a convenient time for your free initial consultation.',
      step1: 'Select Date',
      step2: 'Select Time',
      step3: 'Enter Details',
      nameLabel: 'Name *',
      ...
      emailPlaceholder: 'your@email.com',
      phonePlaceholder: '+49 ...',
      messagePlaceholder: 'What is your project about?',
      selectPlaceholder: 'Please select...',
      optionKI: 'AI Agents',
      optionAutomation: 'Automations',
      optionWeb: 'Websites with AI',
      optionMarketing: 'Performance Marketing',
      optionConsulting: 'General Consultation',
      submitButton: 'Book Appointment',
      backButton: 'Back',
      nextButton: 'Next',
      noSlots: 'No appointments available',
      thankYouTitle: 'Appointment Booked!',
      thankYouMessage: 'We have confirmed your appointment and will send you a calendar invitation via email.',
    ...
    locations: {
      common: {
        freeConsultation: 'Free Consultation',
        bookAppointment: 'Book Appointment',
        partnerTitle: 'Your Partner for AI & Automation in',
        contactIn: 'Contact in',
        phone: 'Phone',
        email: 'Email',
        hours: 'Opening Hours',
        hoursValue: 'Mon-Fri: 08:00 - 18:00',
        showOnMaps: 'Show on Google Maps',
        servicesTitle: 'Our Services in',
        servicesSubtitle: 'We support businesses in',
        servicesSubtitleEnd: 'with innovative AI solutions.',
        industriesTitle: 'Industries in',
        industriesSubtitle: 'We have experience with various industries in the region.',
        nearbyTitle: 'We also serve businesses in the surrounding area',
        ctaTitle: 'Ready for the digital future in',
        ctaSubtitle: 'Let us explore together how AI and automation can advance your business.',
        ctaContact: 'Contact Us Now',
        ctaBooking: 'Free Initial Consultation',
        kiAgency: 'AI Agency',
        region: 'Germany',
        breadcrumbHome: 'Home',
        breadcrumbLocations: 'Locations',
        seoKeywords: 'AI Agency, Automation, AI',
        services: {
          kiAgents: { title: 'AI Agents', desc: 'Intelligent chatbots and virtual assistants for customer service and lead generation.' },
          automation: { title: 'Automation', desc: 'Workflow automation with n8n for more efficient business processes.' },
          websites: { title: 'AI Websites', desc: 'Modern websites with integrated AI features and chatbots.' },
          marketing: { title: 'Performance Marketing', desc: 'Google Ads, Meta Ads and SEO for maximum visibility.' }
        }
      },
      muenchen: {
        name: 'Munich',
        region: 'Bavaria',
        headline: 'Your AI agency for Munich and the surrounding area. We automate processes, develop AI agents and create modern websites.',
        intro: 'As an AI agency based in the Munich metropolitan area, we understand the requirements of Bavarian companies. From startups in Schwabing to established mid-sized companies in the region – we develop customized AI solutions that optimize your processes and accelerate your growth.',
        whyUs: [
          'Local presence in the Munich metropolitan area',
          'Experience with Bavarian companies of all sizes',
          'Fast response times and personal support',
          'German-speaking support and documentation',
          'GDPR-compliant data protection'
        ],
        industries: ['Automotive', 'IT & Tech', 'Financial Services', 'Insurance', 'Medical Technology', 'Mechanical Engineering', 'Retail', 'Hospitality', 'Real Estate', 'Consulting']
      },
      fuerstenfeldbruck: {
        name: 'Fürstenfeldbruck',
        region: 'Bavaria',
        headline: 'Your local partner for AI & automation in the Fürstenfeldbruck district. Personal consultation on-site.',
        intro: 'With our headquarters in Fürstenfeldbruck, we are your local partner. We know the local economy and support companies in the FFB district with digital transformation. Whether craft business, service provider or manufacturing company – we find the right AI solution for your business.',
        whyUs: [
          'Headquarters directly in Fürstenfeldbruck',
          'Personal meetings on-site possible',
          'Knowledge of local economic structures',
          'Short distances and fast response times',
          'Support from first meeting to implementation'
        ],
        industries: ['Crafts', 'Retail', 'Hospitality', 'Services', 'Healthcare', 'Education', 'Real Estate', 'Logistics', 'Manufacturing', 'Agriculture']
      },
      bayern: {
        name: 'Bavaria',
        region: 'Bavaria',
        headline: 'Your AI agency for all of Bavaria. From Munich to Nuremberg, from Augsburg to Regensburg – we are here for you.',
        intro: 'Bavaria is a business location with diverse industries – from the automotive industry to mechanical engineering to innovative startups. As a Bavarian AI agency, we understand the needs of the regional economy and develop solutions that fit your company.',
        whyUs: [
          'Bavarian company with local know-how',
          'Support throughout Bavaria – on-site or remote',
          'Understanding of regional economic structures',
          'Network with Bavarian partners and funding',
          'German quality and GDPR compliance'
        ],
        industries: ['Automotive', 'Mechanical Engineering', 'Electrical Engineering', 'IT & Software', 'Tourism', 'Agriculture', 'Retail', 'Crafts', 'Healthcare', 'Logistics', 'Finance', 'Energy']
      }
    },
  },
  hr: {
    ...
    contact: {
      ...
      directAppointment: 'Direktan termin',
    ...
    contactPage: {
      ...
      nationwideTitle: 'DACH regija usluga',
      nationwideDesc: 'Naše sjedište je u Fürstenfeldbrucku kod Münchena. Radimo online u cijeloj DACH regiji (Njemačka, Austrija, Švicarska).',
    ...
    terminbuchungPage: {
      badge: 'Rezervirajte termin',
      title: 'Zakažite konzultaciju',
      subtitle: 'Odaberite prikladan termin za vaš besplatni prvi razgovor.',
      step1: 'Odaberite datum',
      step2: 'Odaberite vrijeme',
      step3: 'Unesite podatke',
      nameLabel: 'Ime *',
      emailLabel: 'E-pošta *',
      phoneLabel: 'Telefon',
      serviceLabel: 'Zainteresirani za *',
      messageLabel: 'Poruka',
      namePlaceholder: 'Vaše ime',
      emailPlaceholder: 'vasa@email.hr',
      phonePlaceholder: '+385 ...',
      messagePlaceholder: 'O čemu se radi u vašem projektu?',
      selectPlaceholder: 'Molimo odaberite...',
      optionKI: 'AI Agenti',
      optionAutomation: 'Automatizacije',
      optionWeb: 'Web stranice s AI',
      optionMarketing: 'Performans marketing',
      optionConsulting: 'Opća konzultacija',
      submitButton: 'Rezervirajte termin',
      backButton: 'Natrag',
      nextButton: 'Dalje',
      noSlots: 'Nema dostupnih termina',
      thankYouTitle: 'Termin rezerviran!',
      thankYouMessage: 'Potvrdili smo vaš termin i poslat ćemo vam pozivnicu za kalendar putem e-pošte.',
      errorMessage: 'Rezervacija nije uspjela. Molimo pokušajte ponovo.'
    },
    socialMediaPage: {
    ...
    locations: {
      common: {
        ...
        bookAppointment: 'Rezervirajte termin',
        partnerTitle: 'Vaš partner za AI i automatizaciju u',
        contactIn: 'Kontakt u',
        phone: 'Telefon',
        email: 'E-mail',
        hours: 'Radno vrijeme',
        hoursValue: 'Pon-Pet: 08:00 - 18:00',
        showOnMaps: 'Prikaži na Google kartama',
        servicesTitle: 'Naše usluge u',
        servicesSubtitle: 'Podržavamo tvrtke u',
        servicesSubtitleEnd: 'inovativnim AI rješenjima.',
        industriesTitle: 'Industrije u',
        industriesSubtitle: 'Imamo iskustva s različitim industrijama u regiji.',
        nearbyTitle: 'Također opslužujemo tvrtke u okolici',
        ctaTitle: 'Spremni za digitalnu budućnost u',
        ctaSubtitle: 'Zajedno istražimo kako AI i automatizacija mogu unaprijediti vaše poslovanje.',
        ctaContact: 'Kontaktirajte nas sada',
        ctaBooking: 'Besplatna prva konzultacija',
        kiAgency: 'AI Agencija',
        region: 'Njemačka',
        breadcrumbHome: 'Početna',
        breadcrumbLocations: 'Lokacije',
        seoKeywords: 'AI Agencija, Automatizacija, AI',
        services: {
          kiAgents: { title: 'AI Agenti', desc: 'Inteligentni chatbotovi i virtualni asistenti za korisničku službu i generiranje leadova.' },
          automation: { title: 'Automatizacija', desc: 'Automatizacija radnih procesa s n8n za učinkovitije poslovne procese.' },
          websites: { title: 'AI Web stranice', desc: 'Moderne web stranice s integriranim AI značajkama i chatbotovima.' },
          marketing: { title: 'Performance Marketing', desc: 'Google Ads, Meta Ads i SEO za maksimalnu vidljivost.' }
        }
      },
      muenchen: {
        name: 'Minhen',
        ...
        whyUs: [
          ...
          'GDPR-sukladna zaštita podataka'
        ],
        industries: ['Automobilska industrija', 'IT & Tech', 'Financijske usluge', 'Osiguranje', 'Medicinska tehnologija', 'Strojogradnja', 'Maloprodaja', 'Ugostiteljstvo', 'Nekretnine', 'Savjetovanje']
      },
      fuerstenfeldbruck: {
        name: 'Fürstenfeldbruck',
        region: 'Bavarska',
        headline: 'Vaš lokalni partner za AI i automatizaciju u okrugu Fürstenfeldbruck. Osobno savjetovanje na licu mjesta.',
        intro: 'S našim sjedištem u Fürstenfeldbrucku, mi smo vaš lokalni partner. Poznajemo lokalno gospodarstvo i podržavamo tvrtke u okrugu FFB u digitalnoj transformaciji. Bilo da se radi o obrtničkom poduzeću, pružatelju usluga ili proizvodnoj tvrtki – pronalazimo pravo AI rješenje za vaše poslovanje.',
        whyUs: [
          'Sjedište izravno u Fürstenfeldbrucku',
          'Osobni sastanci na licu mjesta mogući',
          'Poznavanje lokalnih gospodarskih struktura',
          'Kratke udaljenosti i brzo vrijeme odziva',
          'Podrška od prvog razgovora do implementacije'
        ],
        industries: ['Obrt', 'Maloprodaja', 'Ugostiteljstvo', 'Usluge', 'Zdravstvo', 'Obrazovanje', 'Nekretnine', 'Logistika', 'Proizvodnja', 'Poljoprivreda']
      },
      bayern: {
        name: 'Bavarska',
        region: 'Bavarska',
        ...
        whyUs: [
          ...
          'Podrška u cijeloj Bavarskoj – na licu mjesta ili na daljinu',
          'Razumijevanje regionalnih gospodarskih struktura',
          'Mreža s bavarskim partnerima i financiranjem',
          'Njemačka kvaliteta i GDPR sukladnost'
        ],
        industries: ['Automobilska industrija', 'Strojogradnja', 'Elektrotehnika', 'IT & Software', 'Turizam', 'Poljoprivreda', 'Maloprodaja', 'Obrt', 'Zdravstvo', 'Logistika', 'Financije', 'Energetika']
      }
    },
  },
  tr: {
    ...
    contact: {
      ...
      phone: 'Telefon',
      webpage: 'Web Sayfası',
      directAppointment: 'Doğrudan Randevu',
      ...
      interest: 'İlgilendiğiniz',
      selectPlaceholder: 'Lütfen seçin...',
      kiAutomation: 'AI ve Otomasyon',
      socialMediaMarketing: 'Sosyal Medya Pazarlama',
      webDevelopment: 'Web Geliştirme',
      performanceMarketing: 'Performans Pazarlama',
      contentCreation: 'İçerik Oluşturma',
      brandBuilding: 'Marka Oluşturma',
      other: 'Diğer',
      message: 'Mesaj',
      messagePlaceholder: 'Size nasıl yardımcı olabiliriz?',
      privacyText: 'Göndererek',
      privacyLink: 'Gizlilik Politikamızı',
      privacyEnd: 'kabul ediyorsunuz.',
      submit: 'Mesaj Gönder',
      thankYou: 'Teşekkürler!',
      thankYouMessage: 'Mesajınız gönderildi. En kısa sürede size geri döneceğiz.',
    },
    about: {
    ...
    contactPage: {
      ...
      nationwideTitle: 'DACH Bölgesi Hizmeti',
      nationwideDesc: 'Merkezimiz Münih yakınlarındaki Fürstenfeldbruck\'tadır. DACH bölgesinde (Almanya, Avusturya, İsviçre) online çalışıyoruz.',
    ...
    terminbuchungPage: {
      badge: 'Randevu Al',
      title: 'Danışma Randevusu Planlayın',
      subtitle: 'Ücretsiz ilk görüşmeniz için uygun bir zaman seçin.',
      step1: 'Tarih Seçin',
      step2: 'Saat Seçin',
      step3: 'Bilgileri Girin',
      nameLabel: 'Ad *',
      emailLabel: 'E-posta *',
      phoneLabel: 'Telefon',
      serviceLabel: 'İlgi Alanı *',
      messageLabel: 'Mesaj',
      namePlaceholder: 'Adınız',
      emailPlaceholder: 'ornek@email.com',
      phonePlaceholder: '+90 ...',
      messagePlaceholder: 'Projeniz ne hakkında?',
      selectPlaceholder: 'Lütfen seçin...',
      optionKI: 'AI Ajanları',
      optionAutomation: 'Otomasyonlar',
      optionWeb: 'AI ile Web Siteleri',
      optionMarketing: 'Performans Pazarlama',
      optionConsulting: 'Genel Danışmanlık',
      submitButton: 'Randevu Al',
      backButton: 'Geri',
      nextButton: 'İleri',
      noSlots: 'Uygun randevu yok',
      thankYouTitle: 'Randevu Alındı!',
      thankYouMessage: 'Randevunuzu onayladık ve size e-posta ile takvim davetiyesi göndereceğiz.',
      errorMessage: 'Rezervasyon başarısız. Lütfen tekrar deneyin.'
    },
    footer: {
      slogan: 'AI, otomasyon ve dijital büyüme için ajansınız.',
      services: 'Hizmetler',
      company: 'Şirket',
      legal: 'Yasal',
      about: 'Hakkımızda',
      ...
      openingHours: 'Pzt–Cu 08:00–17:00',
      legalInfo: 'Genel Müdür: Bkz. Yasal Bildirim',
      addressLabel: 'Adres',
      emailLabel: 'E-posta',
      phoneLabel: 'Telefon',
    ...
    chatbot: {
      title: 'AI Asistanı',
      subtitle: 'Akıllı chatbotumuzu test edin',
    ...
    automationPage: {
      ...
      title: 'İşletmenizi Otomatikleştirin',
      subtitle: 'Araçlarınızı bağlıyor ve tekrarlayan görevleri otomatikleştiriyoruz – böylece asıl önemli işlere odaklanabilirsiniz.',
      ctaPrimary: 'Ücretsiz Danışmanlık',
      ctaSecondary: 'Olanakları Keşfedin',
      automationsTitle: 'Neleri otomatikleştiriyoruz',
      automationsSubtitle: 'E-posta iş akışlarından tam süreç otomasyonuna kadar – mükemmel çözümü buluyoruz.',
      examples: 'Örnekler:',
      toolsTitle: 'Araçlarımız',
      toolsSubtitle: 'Maksimum güvenilirlik için kanıtlanmış otomasyon platformlarını kullanıyoruz.',
      processTitle: 'Sürecimiz',
      processSubtitle: 'Analizden canlıya geçişe – otomasyonunuz böyle oluşuyor.',
      faqTitle: 'Otomasyon Hakkında Sık Sorulan Sorular',
      ctaTitle: 'Daha fazla verimlilik için hazır mısınız?',
      n8nBadge: 'n8n ile çalışır',
      n8nTitle: 'Neden n8n kullanıyoruz',
      n8nDescription: 'n8n, en güçlü açık kaynak otomasyon platformudur. Bununla tam olarak ihtiyaçlarınıza uygun iş akışları oluşturuyoruz – diğer araçların sınırlamaları olmadan.',
      n8nFeatures: [
        '500\'den fazla entegrasyon mevcut',
        'Yürütme sayısında sınırlama yok',
        'Maksimum veri kontrolü için self-hosting',
        'Karmaşık mantık ve dallanma mümkün',
        'Her sistem için API bağlantıları',
        'Zapier ve Make\'den daha ekonomik'
      ],
      visualWorkflows: 'Görsel İş Akışları',
      visualWorkflowsDesc: 'Net, anlaşılır, bakımı kolay',
      workflowSteps: ['Tetikleyici', 'Koşul', 'Eylem 1', 'Eylem 2'],
      ctaSubtitle: 'Sizin için hangi süreçleri otomatikleştirebileceğimizi analiz edelim. Ücretsiz ilk danışmanlık.',
      automations: [
        { title: 'E-posta Otomasyonu', description: 'E-postaların otomatik gönderimi, sıralaması ve yanıtlanması. Karşılama dizileri, takipler ve kişiselleştirilmiş kampanyalar otopilotta.', examples: ['Karşılama e-postaları', 'Potansiyel müşteri besleme', 'Sepet terk edenler', 'Bülten segmentasyonu'] },
        { title: 'Potansiyel Müşteri Yönetimi', description: 'Potansiyel müşterileri otomatik olarak yakalayın, değerlendirin ve satışa aktarın. CRM entegrasyonu ve otomatik puanlama.', examples: ['Formlar → CRM', 'Potansiyel müşteri puanlama', 'Otomatik atama', 'Takip hatırlatıcıları'] },
        { title: 'Belge İş Akışları', description: 'Faturaları, sözleşmeleri ve belgeleri otomatik olarak işleyin, arşivleyin ve yönlendirin. OCR tanıma dahil.', examples: ['Fatura işleme', 'Sözleşme yönetimi', 'Dijital imzalar', 'Arşivleme'] },
        { title: 'E-Ticaret Otomasyonu', description: 'Siparişleri, stokları ve kargoyu otomatik olarak yönetin. Mağaza, muhasebe ve kargo arasında senkronizasyon.', examples: ['Sipariş onayları', 'Stok senkronizasyonu', 'İade iş akışı', 'Değerlendirme talepleri'] },
        { title: 'Randevu Otomasyonu', description: 'Rezervasyonlar, hatırlatıcılar ve takvim senkronizasyonu tamamen otomatik. Çift randevu yok, unutulan toplantı yok.', examples: ['Online rezervasyon', 'Hatırlatıcılar', 'Takvim senkronizasyonu', 'Gelmeme yönetimi'] },
        { title: 'Veri Senkronizasyonu', description: 'Tüm sistemlerinizi senkron tutun. Bir araçtaki değişiklikler otomatik olarak diğerlerinde güncellenir.', examples: ['CRM ↔ Muhasebe', 'Mağaza ↔ Depo', 'Kişiler senkron', 'Stok eşleştirme'] },
        { title: 'Raporlama Otomasyonu', description: 'Raporların otomatik oluşturulması ve gönderilmesi. Günlük, haftalık veya aylık değerlendirmeler manuel çaba olmadan.', examples: ['Ciro raporları', 'Pazarlama KPI\'ları', 'Çalışan panelleri', 'Müşteri analizleri'] },
        { title: 'Süreç İş Akışları', description: 'Karmaşık iş süreçlerini otomatikleştirin: Onaylar, yükseltmeler ve akıllı kurallarla çok aşamalı süreçler.', examples: ['Onay iş akışları', 'Yükseltme zincirleri', 'Oryantasyon', 'Kontrol listeleri'] }
      ],
      benefits: [
        { title: '%80 Zaman Tasarrufu', description: 'Manuel görevler otomatik olarak yapılır' },
        { title: 'Daha Az Hata', description: 'Dikkatsizlik hataları olmadan tutarlı süreçler' },
        { title: 'Ölçeklenebilir', description: 'Daha fazla personel olmadan daha fazla hacim' },
        { title: 'Daha Hızlı', description: 'Süreçler 7/24 saniyeler içinde çalışır' }
      ],
      tools: [
      ...
      processSteps: [
        { title: 'Analiz', description: 'Mevcut süreçlerinizi anlıyor ve otomasyon potansiyelini belirliyoruz.' },
        { title: 'Konsept', description: 'Birlikte optimal iş akışını tanımlıyor ve uygun araçları seçiyoruz.' },
        { title: 'Uygulama', description: 'Otomasyonunuzu n8n veya uygun araçla oluşturuyoruz.' },
        { title: 'Test', description: 'Kapsamlı testler her şeyin sorunsuz çalıştığından emin olur.' },
        { title: 'Canlıya Geçiş', description: 'İş akışınız izleme ve sürekli optimizasyonla canlıya geçer.' }
      ],
      faqs: [
        { q: 'Bir otomasyon ne kadar?', a: 'Basit otomasyonlar 500€\'dan başlar. Birden fazla sistemle daha karmaşık iş akışları 1.500€\'dan başlar. Ücretsiz ilk danışmanlıkta somut bir teklif oluşturuyoruz.' },
        ...
        { q: 'Uygulama ne kadar sürer?', a: 'Basit iş akışları 1-2 günde hazır. Birden fazla entegrasyonla daha karmaşık otomasyonlar 1-2 hafta gerektirir. İlk danışmanlıkta gerçekçi bir zaman çizelgesi sunuyoruz.' },
        { q: 'Otomasyonları kendim ayarlayabilir miyim?', a: 'Evet! n8n veya kullanılan araç konusunda sizi eğitiyoruz. Basit ayarlamaları kendiniz yapabilirsiniz. Daha karmaşık değişiklikler için yanınızdayız.' },
        ...
        { q: 'Verilerim güvende mi?', a: 'Evet! Şifreli bağlantılar ve GDPR uyumlu çözümler kullanıyoruz. İstek üzerine maksimum veri kontrolü için n8n\'i kendi sunucularınızda da barındırıyoruz.' }
      ],
    },
    websitesPage: {
    ...
    contentPage: {
      badge: 'Hizmet',
      title: 'Metin Yazımı & Paylaşımlar',
      subtitle: 'Etkileşimi artıran, mesajınızı ileten ve satan hedef kitleye yönelik metinler ve yaratıcı sosyal medya paylaşımları.',
      ctaButton: 'Ücretsiz Danışmanlık',
      servicesTitle: 'Sizin için neler yapıyoruz',
      services: [
        { title: 'Sosyal Medya Paylaşımları', desc: 'Tüm platformlar için yaratıcı, dikkat çekici paylaşımlar.' },
        { title: 'Reklam Metinleri', desc: 'Reklamlar, landing page\'ler ve kampanyalar için ikna edici metinler.' },
        { title: 'Blog Yazıları', desc: 'Uzmanlık gösteren SEO optimize makaleler.' },
        { title: 'Bülten', desc: 'Yüksek açılma ve tıklama oranlarına sahip çekici e-posta metinleri.' },
        { title: 'Web Sitesi Metinleri', desc: 'Tüm online varlığınız için satış odaklı metinler.' },
        { title: 'İçerik Stratejisi', desc: 'Sürekli çıktı için editoryal planlar ve konu konseptleri.' }
      ],
      benefitsTitle: 'Avantajlarınız',
      benefits: [
        'Hedef kitlenize hitap eden profesyonel metinler',
        'Tüm kanallarda tutarlı marka sesi',
        'İlgili içerikle daha yüksek etkileşim oranları',
        'Dış içerik üretimiyle zaman tasarrufu',
        'Daha iyi görünürlük için SEO optimize içerik'
      ],
      ctaTitle: 'Etkili içerik için hazır mısınız?',
      ctaSubtitle: 'Hedef kitlenizi heyecanlandıran ve harekete geçiren içerikler oluşturalım.',
    ...
    brandPage: {
      badge: 'Hizmet',
      title: 'Marka Oluşturma & Marka Kimliği',
      subtitle: 'Güven oluşturan, akılda kalan ve işletmenizi rekabetten ayıran benzersiz marka kimlikleri geliştirme.',
      ctaButton: 'Ücretsiz Danışmanlık',
      servicesTitle: 'Sizin için neler yapıyoruz',
      services: [
        { title: 'Marka Analizi', desc: 'Mevcut konumunuzun ve rekabet ortamının derinlemesine analizi.' },
        { title: 'Marka Stratejisi', desc: 'Net konumlandırma ve marka mesajı geliştirme.' },
        { title: 'Logo & Görsel Tasarım', desc: 'Benzersiz logo ve görsel tasarım yönergeleri oluşturma.' },
        { title: 'Kurumsal Tasarım', desc: 'Renkler, tipografi ve görsel dil dahil tam görünüm.' },
        { title: 'Marka Kılavuzları', desc: 'Tutarlı uygulama için tüm marka unsurlarının belgelenmesi.' },
        { title: 'Marka Yenileme', desc: 'Mevcut markaları dijital gelecek için modernleştirme.' }
      ],
      benefitsTitle: 'Avantajlarınız',
      benefits: [
        'Rekabetten sıyrılan benzersiz marka kimliği',
        'Tüm kanallarda tutarlı görünüm',
        'Duygusal marka deneyimleriyle daha güçlü müşteri bağlılığı',
        'Daha yüksek tanınırlık ve marka bilinirliği',
        'Daha fazla güven için profesyonel dış görünüm'
      ],
      ctaTitle: 'Güçlü markanız için hazır mısınız?',
      ctaSubtitle: 'Değerlerinizi somutlaştıran ve hedef kitlenizi heyecanlandıran bir marka birlikte geliştirelim.',
      ctaButtonAlt: 'Şimdi projeye başla'
    },
    webPage: {
    ...
    locations: {
      common: {
        freeConsultation: 'Ücretsiz Danışmanlık',
        bookAppointment: 'Randevu Al',
        partnerTitle: 'AI ve Otomasyon için Ortağınız -',
        contactIn: 'İletişim -',
        phone: 'Telefon',
        email: 'E-posta',
        hours: 'Çalışma Saatleri',
        hoursValue: 'Pzt-Cum: 08:00 - 18:00',
        showOnMaps: 'Google Haritalar\'da Göster',
        servicesTitle: 'Hizmetlerimiz -',
        servicesSubtitle: 'İşletmeleri destekliyoruz -',
        servicesSubtitleEnd: 'yenilikçi AI çözümleriyle.',
        industriesTitle: 'Sektörler -',
        industriesSubtitle: 'Bölgedeki çeşitli sektörlerle deneyimimiz var.',
        nearbyTitle: 'Çevredeki işletmelere de hizmet veriyoruz',
        ctaTitle: 'Dijital geleceğe hazır mısınız -',
        ctaSubtitle: 'AI ve otomasyonun işletmenizi nasıl ilerletebileceğini birlikte keşfedelim.',
        ctaContact: 'Şimdi İletişime Geçin',
        ctaBooking: 'Ücretsiz İlk Danışmanlık',
        kiAgency: 'AI Ajansı',
        region: 'Almanya',
        breadcrumbHome: 'Ana Sayfa',
        breadcrumbLocations: 'Konumlar',
        seoKeywords: 'AI Ajansı, Otomasyon, AI',
        services: {
          kiAgents: { title: 'AI Ajanları', desc: 'Müşteri hizmetleri ve potansiyel müşteri oluşturma için akıllı chatbotlar ve sanal asistanlar.' },
          automation: { title: 'Otomasyon', desc: 'Daha verimli iş süreçleri için n8n ile iş akışı otomasyonu.' },
          websites: { title: 'AI Web Siteleri', desc: 'Entegre AI özellikleri ve chatbotlarla modern web siteleri.' },
          marketing: { title: 'Performans Pazarlama', desc: 'Maksimum görünürlük için Google Ads, Meta Ads ve SEO.' }
        }
      },
      muenchen: {
        name: 'Münih',
        region: 'Bavyera',
        headline: 'Münih ve çevresi için AI ajansınız. Süreçleri otomatikleştiriyoruz, AI ajanları geliştiriyoruz ve modern web siteleri oluşturuyoruz.',
        intro: 'Münih metropol bölgesinde merkezli bir AI ajansı olarak, Bavyeralı şirketlerin gereksinimlerini anlıyoruz. Schwabing\'deki startuplardan bölgedeki yerleşik orta ölçekli şirketlere kadar – süreçlerinizi optimize eden ve büyümenizi hızlandıran özelleştirilmiş AI çözümleri geliştiriyoruz.',
        whyUs: [
          'Münih metropol bölgesinde yerel varlık',
          'Her ölçekten Bavyeralı şirketle deneyim',
          'Hızlı yanıt süreleri ve kişisel destek',
          'Almanca destek ve dokümantasyon',
          'GDPR uyumlu veri koruma'
        ],
        industries: ['Otomotiv', 'IT & Teknoloji', 'Finansal Hizmetler', 'Sigorta', 'Medikal Teknoloji', 'Makine Mühendisliği', 'Perakende', 'Konaklama', 'Gayrimenkul', 'Danışmanlık']
      },
      fuerstenfeldbruck: {
        name: 'Fürstenfeldbruck',
        region: 'Bavyera',
        headline: 'Fürstenfeldbruck bölgesi için AI ve otomasyon ortağınız. Yerinde kişisel danışmanlık.',
        intro: 'Fürstenfeldbruck\'taki genel merkezimizle yerel ortağınızız. Yerel ekonomiyi tanıyoruz ve FFB bölgesindeki şirketleri dijital dönüşümde destekliyoruz. İster zanaat işletmesi, ister hizmet sağlayıcı, ister üretim şirketi olsun – işletmeniz için doğru AI çözümünü buluyoruz.',
        whyUs: [
          'Doğrudan Fürstenfeldbruck\'ta genel merkez',
          'Yerinde kişisel toplantılar mümkün',
          'Yerel ekonomik yapılar hakkında bilgi',
          'Kısa mesafeler ve hızlı yanıt süreleri',
          'İlk görüşmeden uygulamaya kadar destek'
        ],
        industries: ['Zanaat', 'Perakende', 'Konaklama', 'Hizmetler', 'Sağlık', 'Eğitim', 'Gayrimenkul', 'Lojistik', 'Üretim', 'Tarım']
      },
      bayern: {
        name: 'Bavyera',
        region: 'Bavyera',
        headline: 'Tüm Bavyera için AI ajansınız. Münih\'ten Nürnberg\'e, Augsburg\'dan Regensburg\'a – sizin için buradayız.',
        intro: 'Bavyera, otomotiv endüstrisinden makine mühendisliğine, yenilikçi startupl\'lara kadar çeşitli sektörlere sahip bir iş merkezi. Bavyeralı bir AI ajansı olarak, bölgesel ekonominin ihtiyaçlarını anlıyor ve şirketinize uygun çözümler geliştiriyoruz.',
        whyUs: [
          'Yerel bilgiye sahip Bavyeralı şirket',
          'Tüm Bavyera\'da destek – yerinde veya uzaktan',
          'Bölgesel ekonomik yapıların anlaşılması',
          'Bavyeralı ortaklar ve finansmanla ağ',
          'Alman kalitesi ve GDPR uyumluluğu'
        ],
        industries: ['Otomotiv', 'Makine Mühendisliği', 'Elektrik Mühendisliği', 'IT & Yazılım', 'Turizm', 'Tarım', 'Perakende', 'Zanaat', 'Sağlık', 'Lojistik', 'Finans', 'Enerji']
      }
    },
  },
};
