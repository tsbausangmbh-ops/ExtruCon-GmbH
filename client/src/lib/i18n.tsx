...
export const translations = {
  de: {
    ...
    hero: {
      location: 'Fürstenfeldbruck · München · Oberbayern · Deutschlandweit',
      badge: 'KI-Agentur für Automatisierung & Chatbots',
      ...
      description: 'Ihre KI-Agentur aus Fürstenfeldbruck bei München. Wir entwickeln intelligente Chatbots, GPT-Agenten und Workflow-Automatisierungen für Kundenservice, Lead-Generierung und Marketing. Persönliche Beratung vor Ort in Oberbayern – Umsetzung deutschlandweit.',
    ...
    services: {
      ...
      subtitle: 'KI-Lösungen & Automatisierung aus Fürstenfeldbruck',
      kiAgents: {
        title: 'KI-Agenten & Chatbots',
        desc: 'GPT-basierte Chatbots für Kundenservice, Support und automatisierte Lead-Qualifizierung',
      },
      automation: {
        title: 'Workflow-Automatisierung',
        desc: 'Geschäftsprozesse mit n8n automatisieren – E-Mail, CRM, Buchhaltung und mehr',
      },
      websites: {
        title: 'Webseiten mit KI',
        desc: 'Moderne Websites mit integrierten Chatbots, KI-Content und SEO-Optimierung',
      },
      socialMedia: {
        title: 'Social Media',
        desc: 'KI-gestütztes Social Media Marketing und automatisiertes Community Management',
      },
      content: {
        title: 'KI-Content Creation',
        desc: 'Automatisierte Texterstellung mit GPT für Blog, Newsletter und Social Media',
      },
      marketing: {
        title: 'Performance Marketing',
        desc: 'Datengetriebenes Marketing mit KI-Analyse für maximalen ROI in München & Bayern',
      },
    },
    contact: {
      title: 'Bereit für',
    ...
    about: {
      badge: 'KI-Agentur aus Fürstenfeldbruck',
      title: 'Innovation trifft',
      titleHighlight: 'Expertise',
      description: 'Die ExtruCon GmbH aus Fürstenfeldbruck bei München ist Ihr Partner für KI-Automatisierung und digitale Transformation. Wir entwickeln Chatbots, GPT-Agenten und Workflow-Automatisierungen für Unternehmen in Bayern und deutschlandweit.',
      whyUs: 'Warum wir?',
  ...
  en: {
    ...
    hero: {
      ...
      badge: 'AI Agency for Automation & Chatbots',
      title1: 'Less routine work.',
      title2: 'More growth.',
      subtitle: 'AI agents handle your recurring tasks –',
      subtitleHighlight: '24/7, error-free, scalable',
      description: 'Your AI agency from Fürstenfeldbruck near Munich. We develop intelligent chatbots, GPT agents and workflow automation for customer service, lead generation and marketing. Personal consultation in Bavaria – implementation Germany-wide.',
    ...
    services: {
      title: 'Our Services',
      subtitle: 'AI Solutions & Automation from Fürstenfeldbruck',
      kiAgents: {
        title: 'AI Agents & Chatbots',
        desc: 'GPT-based chatbots for customer service, support and automated lead qualification',
      },
      automation: {
        title: 'Workflow Automation',
        desc: 'Automate business processes with n8n – email, CRM, accounting and more',
      },
      websites: {
        title: 'AI Websites',
        desc: 'Modern websites with integrated chatbots, AI content and SEO optimization',
      },
      socialMedia: {
        title: 'Social Media',
        desc: 'AI-powered social media marketing and automated community management',
      },
      content: {
        title: 'AI Content Creation',
        desc: 'Automated content creation with GPT for blog, newsletter and social media',
      },
      marketing: {
        title: 'Performance Marketing',
        desc: 'Data-driven marketing with AI analysis for maximum ROI in Munich & Bavaria',
      },
    },
    contact: {
      title: 'Ready for',
