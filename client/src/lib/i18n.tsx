...
export const translations = {
  ...
  tr: {
    ...
    about: {
      ...
      description: 'ExtruCon GmbH, Fürstenfeldbruck merkezli bir AI ajansıdır. İşletmelerin AI ve otomasyon yoluyla büyümelerine yardımcı olan yenilikçi çözümler sunuyoruz.',
      mission: 'Misyonumuz',
      missionText: 'AI teknolojilerini erişilebilir ve kullanılabilir hale getirerek işletmelerin verimliliğini artırmak ve rekabet avantajı sağlamak.',
      vision: 'Vizyonumuz',
      visionText: 'Her işletmenin AI destekli çözümlerden faydalanabildiği bir gelecek yaratmak.',
    },
    faq: {
    ...
    chatbotPage: {
      title: 'AI Asistanımızı Test Edin',
      subtitle: 'ExtruCon AI asistanıyla doğrudan sohbet edin',
      description: 'Hizmetlerimiz, fiyatlarımız ve AI çözümlerimiz hakkında sorular sorun.',
    },
    common: {
    ...
    kiAgentsPage: {
      heroTitle: 'AI Ajanları',
      heroSubtitle: 'İşletmeniz için akıllı otomasyon',
      heroDescription: 'Müşteri hizmetleri, satış ve destek süreçlerinizi 7/24 otomatikleştirin.',
      features: 'Özellikler',
      benefits: 'Avantajlar',
      pricing: 'Fiyatlandırma',
      ctaTitle: 'Hemen Başlayın',
      ctaSubtitle: 'AI ajanlarının işletmenizi nasıl dönüştürebileceğini keşfedin.',
    ...
    legalPages: {
      ...
      legalNotice: 'Not: Bu sayfa Alman yasal gerekliliklerine uyum sağlamak için Almanca\'dır.'
    },
    cookieConsent: {
