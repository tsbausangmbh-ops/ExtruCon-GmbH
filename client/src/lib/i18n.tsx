...
export const translations = {
  de: {
    ...
    kiAgentsPage: {
      ...
      whyTitle: 'Vorteile von KI-Agenten für Unternehmen',
      whySubtitle: 'Die Vorteile intelligenter Automatisierung für Ihr Unternehmen.',
      agentsTitle: '8 spezialisierte KI-Agenten für jede Aufgabe',
      ...
      faqTitle: 'FAQ: Häufige Fragen zu KI-Agenten',
    ...
    automationPage: {
      ...
      automationsTitle: 'Automatisierungslösungen für jeden Bereich',
      automationsSubtitle: 'Von E-Mail-Workflows bis zur kompletten Prozessautomatisierung – wir finden die perfekte Lösung.',
      examples: 'Beispiele:',
      toolsTitle: 'Automatisierungs-Tools & Plattformen',
      toolsSubtitle: 'Wir setzen auf bewährte Automatisierungs-Plattformen für maximale Zuverlässigkeit.',
      processTitle: 'Workflow-Automatisierung: Unser Ablauf',
      processSubtitle: 'Von der Analyse bis zum Go-Live – so entsteht Ihre Automatisierung.',
      faqTitle: 'FAQ: Häufige Fragen zur Workflow-Automatisierung',
      ctaTitle: 'Automatisierung anfragen – Kostenlose Beratung',
      n8nBadge: 'Powered by n8n',
      n8nTitle: 'n8n Automatisierung: Die leistungsstarke Plattform',
    ...
    legalPages: {
      ...
      privacySummary: 'ExtruCon GmbH verarbeitet Ihre personenbezogenen Daten gemäß der DSGVO und dem deutschen Datenschutzrecht (BDSG, TTDSG). Sie haben das Recht auf Auskunft, Berichtigung, Löschung und Widerspruch.',
    ...
    terminPage: {
      ...
      description: 'Wählen Sie einen passenden Termin für Ihr kostenloses Beratungsgespräch. Wir sind Montag bis Freitag von 08:00 bis 17:00 Uhr für Sie da.',
      openingHours: 'Öffnungszeiten',
      mondayFriday: 'Montag - Freitag',
      saturdaySunday: 'Samstag & Sonntag',
      closed: 'Geschlossen',
      closedWeekend: 'Geschlossen (Sa/So)',
      selected: 'Ausgewählt',
      ...
      emailPlaceholder: 'ihre@email.de',
      phonePlaceholder: '+49 ...',
      messagePlaceholder: 'Worum geht es bei Ihrem Anliegen?',
      serviceLabel: 'Interesse an',
      selectPlaceholder: 'Bitte wählen...',
      optionKI: 'KI-Agenten & Chatbots',
      optionAutomation: 'Workflow-Automatisierung',
      ...
      successEmailInfo: 'Sie erhalten in Kürze eine Bestätigung per E-Mail',
      bookAnother: 'Weiteren Termin buchen',
      alternativeSlots: 'Alternative Termine:',
      availableTimes: 'Verfügbare Zeiten',
      noAvailableTimes: 'Keine verfügbaren Zeiten an diesem Tag',
      weekendClosed: 'Wochenende - Geschlossen',
      couldNotLoadTimes: 'Zeiten konnten nicht geladen werden',
      requiredFields: '* Pflichtfelder. Ihre Daten werden gemäß unserer Datenschutzerklärung verarbeitet.',
      oclock: 'Uhr',
  ...
  en: {
    ...
    kiAgentsPage: {
      ...
      whyTitle: 'Benefits of AI Agents for Businesses',
      whySubtitle: 'The benefits of intelligent automation for your business.',
      agentsTitle: '8 Specialized AI Agents for Every Task',
    ...
    automationPage: {
      ...
      automationsTitle: 'Automation Solutions for Every Area',
      automationsSubtitle: 'From email workflows to complete process automation – we find the perfect solution.',
      examples: 'Examples:',
      toolsTitle: 'Automation Tools & Platforms',
      toolsSubtitle: 'We rely on proven automation platforms for maximum reliability.',
      processTitle: 'Workflow Automation: Our Process',
      processSubtitle: 'From analysis to go-live – this is how your automation is created.',
      faqTitle: 'FAQ: Frequently Asked Questions About Workflow Automation',
      ctaTitle: 'Request Automation – Free Consultation',
      n8nBadge: 'Powered by n8n',
      n8nTitle: 'n8n Automation: The Powerful Platform',
    ...
    legalPages: {
      ...
      privacySummary: 'ExtruCon GmbH processes your personal data in accordance with the GDPR and German data protection law (BDSG, TTDSG). You have the right to access, rectification, deletion, and objection.',
    ...
    terminPage: {
      ...
      description: 'Choose a suitable appointment for your free consultation. We are available Monday to Friday from 8:00 AM to 5:00 PM.',
      openingHours: 'Opening Hours',
      mondayFriday: 'Monday - Friday',
      saturdaySunday: 'Saturday & Sunday',
      closed: 'Closed',
      closedWeekend: 'Closed (Sat/Sun)',
      selected: 'Selected',
      ...
      emailPlaceholder: 'your@email.com',
      phonePlaceholder: '+1 ...',
      messagePlaceholder: 'What is your inquiry about?',
      serviceLabel: 'Interested in',
      selectPlaceholder: 'Please select...',
      optionKI: 'AI Agents & Chatbots',
      optionAutomation: 'Workflow Automation',
      optionWeb: 'AI-Powered Websites',
      optionMarketing: 'Performance Marketing',
      optionOther: 'Other',
      bookButton: 'Book Appointment',
      booking: 'Booking...',
      successTitle: 'Appointment successfully booked!',
      successEmailInfo: 'You will receive a confirmation email shortly',
      bookAnother: 'Book Another Appointment',
      alternativeSlots: 'Alternative Appointments:',
      availableTimes: 'Available Times',
      noAvailableTimes: 'No available times on this day',
      weekendClosed: 'Weekend - Closed',
      couldNotLoadTimes: 'Could not load times',
      requiredFields: '* Required fields. Your data will be processed according to our privacy policy.',
      oclock: '',
  ...
  hr: {
    ...
    kiAgentsPage: {
      ...
      whyTitle: 'Prednosti AI Agenata za Tvrtke',
      whySubtitle: 'Prednosti inteligentne automatizacije za vaše poslovanje.',
      agentsTitle: '8 Specijaliziranih AI Agenata za Svaki Zadatak',
    ...
    legalPages: {
      ...
      privacySummary: 'ExtruCon GmbH obrađuje vaše osobne podatke u skladu s GDPR-om, njemačkim zakonom o zaštiti podataka (BDSG, TTDSG) i hrvatskim propisima (AZOP). Imate pravo na pristup, ispravak, brisanje i prigovor.',
      applicableLaws: 'Primjenjivi zakoni',
      applicableLawsList: '• Opća uredba EU o zaštiti podataka (GDPR) EU 2016/679\n• Zakon o provedbi Opće uredbe o zaštiti podataka (NN 42/18)\n• Zakon o elektroničkim komunikacijama (ZEK)\n• Njemački savezni zakon o zaštiti podataka (BDSG)\n• TTDSG (Njemački zakon o telekomunikacijama i telemedijima)',
    ...
    terminPage: {
      ...
      title: 'Rezervirajte',
      titleHighlight: 'termin',
      description: 'Odaberite prikladan termin za besplatni konzultacijski razgovor. Dostupni smo od ponedjeljka do petka od 08:00 do 17:00.',
      openingHours: 'Radno vrijeme',
      mondayFriday: 'Ponedjeljak - Petak',
      saturdaySunday: 'Subota i Nedjelja',
      closed: 'Zatvoreno',
      closedWeekend: 'Zatvoreno (Sub/Ned)',
      selected: 'Odabrano',
      yourContactData: 'Vaši kontakt podaci',
      selectedAppointment: 'Odabrani termin:',
      name: 'Ime *',
      company: 'Tvrtka',
      email: 'E-mail *',
      phone: 'Telefon',
      ...
      emailPlaceholder: 'vaš@email.hr',
      phonePlaceholder: '+385 ...',
      messagePlaceholder: 'O čemu se radi?',
      serviceLabel: 'Zainteresirani za',
      selectPlaceholder: 'Molimo odaberite...',
      optionKI: 'AI agenti i chatbotovi',
      optionAutomation: 'Automatizacija radnih tokova',
      optionWeb: 'Web stranice s AI',
      optionMarketing: 'Performance marketing',
      optionOther: 'Ostalo',
      bookButton: 'Rezerviraj termin',
      booking: 'Rezervacija u tijeku...',
      successTitle: 'Termin uspješno rezerviran!',
      successEmailInfo: 'Uskoro ćete primiti potvrdu putem e-maila',
      bookAnother: 'Rezerviraj novi termin',
      alternativeSlots: 'Alternativni termini:',
      availableTimes: 'Dostupna vremena',
      noAvailableTimes: 'Nema dostupnih termina za ovaj dan',
      weekendClosed: 'Vikend - Zatvoreno',
      couldNotLoadTimes: 'Nije moguće učitati vremena',
      requiredFields: '* Obavezna polja. Vaši podaci bit će obrađeni u skladu s našom politikom privatnosti.',
      oclock: 'h',
  ...
  tr: {
    ...
    kiAgentsPage: {
      ...
      whyTitle: 'Isletmeler icin AI Ajanlarinin Avantajlari',
      whySubtitle: 'İşletmeniz için akıllı otomasyonun avantajları.',
      agentsTitle: 'Her Gorev icin 8 Uzman AI Ajani',
      ...
      useCasesTitle: 'AI Ajanlarinin Pratikte Kullanim Alanlari',
      useCasesSubtitle: 'AI ajanları tüm iş alanlarında size destek olur.',
      howTitle: 'AI Ajani Gelistirme: Basariya 5 Adim',
      howSubtitle: '5 adımda kişisel AI ajanınız.',
      techTitle: 'Kullanilan Modern AI Teknolojileri',
      techSubtitle: 'Ajanlarınız için en modern AI teknolojilerini kullanıyoruz.',
      pricingTitle: 'AI Ajanlari Fiyatlandirma ve Maliyetler',
      ...
      faqTitle: 'SSS: AI Ajanları Hakkında Sık Sorulan Sorular',
    ...
    legalPages: {
      ...
      privacySummary: 'ExtruCon GmbH, kişisel verilerinizi GDPR, Alman veri koruma yasaları (BDSG, TTDSG) ve Türk KVKK mevzuatına uygun olarak işlemektedir. Erişim, düzeltme, silme ve itiraz hakkına sahipsiniz.',
    ...
    terminPage: {
      ...
      title: 'Randevu',
      titleHighlight: 'Al',
      description: 'Ücretsiz danışma görüşmeniz için uygun bir randevu seçin. Pazartesi - Cuma 08:00 - 17:00 arası hizmetinizdeyiz.',
      openingHours: 'Çalışma Saatleri',
      mondayFriday: 'Pazartesi - Cuma',
      saturdaySunday: 'Cumartesi & Pazar',
      closed: 'Kapalı',
      closedWeekend: 'Kapalı (Cts/Paz)',
      selected: 'Seçildi',
      yourContactData: 'İletişim Bilgileriniz',
      ...
      phonePlaceholder: '+90 ...',
      messagePlaceholder: 'Konunuz nedir?',
      serviceLabel: 'İlgilenilen alan',
      selectPlaceholder: 'Lütfen seçin...',
      optionKI: 'AI Ajanları ve Chatbotlar',
      optionAutomation: 'İş Akışı Otomasyonu',
      optionWeb: 'AI Destekli Web Siteleri',
      optionMarketing: 'Performans Pazarlama',
      optionOther: 'Diğer',
      bookButton: 'Randevu Al',
      booking: 'Rezervasyon yapılıyor...',
      successTitle: 'Randevu başarıyla alındı!',
      successEmailInfo: 'Kısa süre içinde e-posta ile onay alacaksınız',
      bookAnother: 'Başka Randevu Al',
      alternativeSlots: 'Alternatif Randevular:',
      availableTimes: 'Uygun Saatler',
      noAvailableTimes: 'Bu gün için uygun saat yok',
      weekendClosed: 'Hafta sonu - Kapalı',
      couldNotLoadTimes: 'Saatler yüklenemedi',
      requiredFields: '* Zorunlu alanlar. Verileriniz gizlilik politikamıza uygun olarak işlenecektir.',
      oclock: '',
