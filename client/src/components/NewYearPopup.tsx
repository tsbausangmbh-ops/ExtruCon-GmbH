...
import fireworksBackground from "@assets/generated_images/optimized/new_year_fireworks_celebration.webp";
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 text-center text-white">
          ...
          <p className="text-sm md:text-base mb-2 text-white/90">
            Auch {currentYear} stehen wir Ihnen als zuverlässiger Partner für KI-Lösungen und Automatisierung zur Seite.
          </p>
