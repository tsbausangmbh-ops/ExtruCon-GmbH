      ...
      <main className="pt-24">
        ...
        <section className="relative py-10 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="Moderne Webseite mit KI-Integration erstellen lassen - Chatbot personalisierte Inhalte intelligente Formulare Webdesign München" className="w-full h-full object-cover opacity-40" fetchPriority="high" decoding="async" width={1920} height={1080} />
