      ...
      <main>
        ...
        <section className="py-12 bg-card/30">
          <div className="container mx-auto px-6">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white text-center mb-10">Unsere Leistungen für Grünwald</h2>
        ...
        <section className="py-12">
          <div className="container mx-auto px-6">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white text-center mb-4">Branchen in Grünwald</h2>
        ...
        <section className="py-12 bg-gradient-to-br from-yellow-900/20 to-background">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white mb-4">Ihr Partner im Isartal</h2>
