      ...
      <main>
        ...
        <section className="py-12 bg-card/30">
          <div className="container mx-auto px-6">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white text-center mb-10">Unsere Leistungen für Germering</h2>
        ...
        <section className="py-12">
          <div className="container mx-auto px-6">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white text-center mb-10">Branchen in Germering</h2>
