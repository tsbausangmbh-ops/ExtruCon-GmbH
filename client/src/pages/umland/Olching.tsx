...
import { Bot, MapPin, Phone, ArrowRight, Workflow, Globe, Wrench, ShoppingBag, Utensils, Building2 } from "lucide-react";
...
export default function Olching() {
  ...
  const industries = [
    { icon: Utensils, title: "Gastronomie", description: "KI-Reservierungssysteme und automatische Bestellbestätigungen." },
    { icon: Wrench, title: "Handwerk", description: "Automatisierte Anfragenverwaltung für lokale Handwerksbetriebe." },
    { icon: ShoppingBag, title: "Einzelhandel", description: "Intelligente Bestandsverwaltung und Kundenkommunikation." },
    { icon: Building2, title: "Dienstleister", description: "Terminbuchung und Workflow-Automatisierung für Büros." }
  ];
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-32 pb-16">
          ...
          <div className="container mx-auto px-6 relative z-10">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-4xl mx-auto">
              <Breadcrumbs items={[{ label: "Startseite", href: "/" }, { label: "München", href: "/muenchen" }, { label: "Olching" }]} />
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-sky-500/10 border border-sky-500/30 rounded-full text-sky-400 text-sm mb-6 mt-8">
              ...
              <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
                Moderne KI-Lösungen für Olching und das Ampertal. Nur 10 Minuten von unserem Hauptsitz.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/termin">
                  <motion.button whileHover={{ scale: 1.05 }} className="px-8 py-4 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-semibold rounded-xl flex items-center gap-2">
