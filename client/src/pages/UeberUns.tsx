      ...
      <main className="pt-24">
        ...
        <section className="relative py-10 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="Über ExtruCon GmbH KI-Agentur Fürstenfeldbruck - Team Experten für künstliche Intelligenz Automatisierung und Webentwicklung München" className="w-full h-full object-cover opacity-40" fetchPriority="high" decoding="async" width={1920} height={1080} />
