      ...
      <main className="pt-24">
        ...
        <section className="relative py-16 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="Kontakt ExtruCon GmbH KI-Agentur Fürstenfeldbruck - kostenlose Beratung zu KI-Agenten Automatisierung und Webentwicklung" className="w-full h-full object-cover opacity-40" fetchPriority="high" decoding="async" width={800} height={437} />
