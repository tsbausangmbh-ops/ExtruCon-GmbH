...
import heroImg from "@/assets/images/hero-seo-abstract.webp";
      ...
      <main className="pt-24">
        ...
        <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-4 pb-4">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="SEO Optimierung und Suchmaschinenmarketing mit KI - lokale Suchmaschinenoptimierung Google Rankings verbessern für Unternehmen München" className="w-full h-full object-cover opacity-50" fetchPriority="high" decoding="async" width={800} height={437} />
