      ...
      <main className="pt-24">
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={webImg} alt="Webentwicklung Agentur Fürstenfeldbruck München - KI-gestützte Websites und Webanwendungen mit React und modernen Technologien" className="w-full h-full object-cover opacity-20" loading="eager" fetchPriority="high" width={1920} height={1080} decoding="async" />
