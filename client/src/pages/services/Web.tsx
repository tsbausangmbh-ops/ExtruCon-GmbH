      ...
      <main className="pt-24">
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="Professionelle Webentwicklung und responsive Webdesign - moderne Webseiten mit KI-Integration und SEO-Optimierung München Fürstenfeldbruck" className="w-full h-full object-cover opacity-40" fetchPriority="high" decoding="async" width={800} height={437} />
        ...
        <section className="py-16 bg-card/20">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white mb-12 text-center">{t.webPage.servicesTitle}</h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white mb-12 text-center">{t.webPage.techTitle}</h2>
        ...
        <section className="py-16 bg-card/20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold font-display text-white mb-8">{t.webPage.benefitsTitle}</h2>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-900/20 to-cyan-900/20">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-bold font-display text-white mb-4">{t.webPage.ctaTitle}</h2>
