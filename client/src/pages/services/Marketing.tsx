      ...
      <main className="pt-24">
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="Performance Marketing Agentur mit KI-gestützter Kampagnenoptimierung - datengetriebene Online-Werbung und Lead-Generierung für Unternehmen München Bayern" className="w-full h-full object-cover opacity-40" fetchPriority="high" decoding="async" width={800} height={437} />
