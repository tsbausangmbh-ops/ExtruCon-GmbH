...
function KI() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      <SEOHead
        title="KI-Lösungen & Automatisierung | München | ExtruCon"
        description="Maßgeschneiderte KI-Lösungen für Ihr Unternehmen. KI-Agenten, ChatGPT Integration, Workflow-Automatisierung in München."
      ...
      <main className="pt-24">
        ...
        <section className="relative py-20 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img src={aiImg} alt="KI Agentur Fürstenfeldbruck - Künstliche Intelligenz und Automatisierung" className="w-full h-full object-cover opacity-20" loading="lazy" decoding="async" />
