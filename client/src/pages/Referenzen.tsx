      ...
      <main className="pt-24">
        ...
        <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-4 pb-4">
          <div className="absolute inset-0 z-0">
            <img src={heroImg} alt="Referenzen & Erfolgsgeschichten" className="w-full h-full object-cover opacity-60" loading="eager" fetchPriority="high" width={1920} height={1080} decoding="async" />
